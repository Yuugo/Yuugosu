...
{ 
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            //Draw the passive elements: Background
        ...
        public void onMouseClick(int theTime)
        {
            for(int i = 0; i < currentObjects.Count; i++)
            {
                        ...
                        theTime <= hc.hitTime + 50))
                {
                    ...
                    so.LoadContent(this.Content);
                    so.Draw(this.spriteBatch, theTime);
                    currentObjects.Remove(hc);
                }
            }
        }
        ...
        {x
            currentScore = currentScore + currentCombo * acc * 100;
        }
    }
}
